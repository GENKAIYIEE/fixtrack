...
export default function AdminTopBar({ user }: { user: UserProps }) {
  ...
  return (
    <header className="print:hidden fixed top-0 right-0 w-[calc(100%-260px)] z-40 border-b border-slate-200 shadow-sm bg-white/80 backdrop-blur-md flex justify-end items-center px-8 h-16">
